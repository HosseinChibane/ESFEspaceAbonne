 ...
 */
class T_Ville_Universite extends \ESF\EspaceAbonneBundle\Entity\T_Ville_Universite implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'ESF\\EspaceAbonneBundle\\Entity\\T_Ville_Universite' . "\0" . 'pays', '' . "\0" . 'ESF\\EspaceAbonneBundle\\Entity\\T_Ville_Universite' . "\0" . 'id', '' . "\0" . 'ESF\\EspaceAbonneBundle\\Entity\\T_Ville_Universite' . "\0" . 'codepostal', '' . "\0" . 'ESF\\EspaceAbonneBundle\\Entity\\T_Ville_Universite' . "\0" . 'commune', '' . "\0" . 'ESF\\EspaceAbonneBundle\\Entity\\T_Ville_Universite' . "\0" . 'region'];
        }
