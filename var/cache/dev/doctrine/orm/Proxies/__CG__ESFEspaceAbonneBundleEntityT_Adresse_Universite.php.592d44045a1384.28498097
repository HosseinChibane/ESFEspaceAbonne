 ...
 */
class T_Adresse_Universite extends \ESF\EspaceAbonneBundle\Entity\T_Adresse_Universite implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'ESF\\EspaceAbonneBundle\\Entity\\T_Adresse_Universite' . "\0" . 'ville', '' . "\0" . 'ESF\\EspaceAbonneBundle\\Entity\\T_Adresse_Universite' . "\0" . 'id', '' . "\0" . 'ESF\\EspaceAbonneBundle\\Entity\\T_Adresse_Universite' . "\0" . 'numero', '' . "\0" . 'ESF\\EspaceAbonneBundle\\Entity\\T_Adresse_Universite' . "\0" . 'rue'];
        }
