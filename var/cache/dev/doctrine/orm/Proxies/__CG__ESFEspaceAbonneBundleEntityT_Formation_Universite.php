 ...
 */
class T_Formation_Universite extends \ESF\EspaceAbonneBundle\Entity\T_Formation_Universite implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'ESF\\EspaceAbonneBundle\\Entity\\T_Formation_Universite' . "\0" . 'langues', '' . "\0" . 'ESF\\EspaceAbonneBundle\\Entity\\T_Formation_Universite' . "\0" . 'universite', '' . "\0" . 'ESF\\EspaceAbonneBundle\\Entity\\T_Formation_Universite' . "\0" . 'id', '' . "\0" . 'ESF\\EspaceAbonneBundle\\Entity\\T_Formation_Universite' . "\0" . 'formation'];
        }
